...
QT_MOC_LITERAL(1, 15, 20), // "senyalTransfAceptada"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 13), // "slotVerificar"
QT_MOC_LITERAL(4, 51, 16) // "slotBotonAceptar"

    },
    "DTransferencia\0senyalTransfAceptada\0"
    "\0slotVerificar\0slotBotonAceptar"
};
...
void DTransferencia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->senyalTransfAceptada((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 1: _t->slotVerificar((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DTransferencia::senyalTransfAceptada)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DTransferencia::senyalTransfAceptada(QString _t1, float _t2)
{
