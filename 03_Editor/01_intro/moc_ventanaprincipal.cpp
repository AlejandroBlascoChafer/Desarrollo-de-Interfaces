...
QT_MOC_LITERAL(3, 28, 15), // "slotGuardarComo"
QT_MOC_LITERAL(4, 44, 10), // "slotCursor"
QT_MOC_LITERAL(5, 55, 11), // "QTextCursor"
QT_MOC_LITERAL(6, 67, 9), // "slotNuevo"
QT_MOC_LITERAL(7, 77, 14) // "slotModificado"

    },
    "VentanaPrincipal\0slotAbrir\0\0slotGuardarComo\0"
    "slotCursor\0QTextCursor\0slotNuevo\0"
    "slotModificado"
};
...
void VentanaPrincipal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotGuardarComo(); break;
        case 2: _t->slotCursor((*reinterpret_cast< QTextCursor(*)>(_a[1]))); break;
        case 3: _t->slotNuevo(); break;
        case 4: _t->slotModificado(); break;
        default: ;
        }
    }
}
